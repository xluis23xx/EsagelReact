  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        to: "/mantenimiento/tipo-documentos",
        icon: <CIcon icon={cilWallet} customClassName="nav-icon" />,
      },
      {
        component: CNavItem,
        name: "Tipo de Cursos",
        to: "/mantenimiento/tipo-cursos",
